...
5. Show the user the staged files list and commit message. Ask for confirmation before committing. Ask the user if they want to check the behavior by running the app. If yes, use the start-app skill to start the app.
